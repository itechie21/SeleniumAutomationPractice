...
public class RightClick {
	...
	public static void main(String[] args) {
		...
		act.contextClick(rightClickElement).perform(); // right click is context click in selenium 
		
		List<WebElement> rightOptionsList = driver
						.findElements(By.xpath("//ul[@class='context-menu-list context-menu-root']/li[contains(@class,'context-menu-icon')]")); // not to include separator
